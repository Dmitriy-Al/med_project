...
public class Config {
    ...
    public final static String CLIENT_ID = ""; // client id из Google API credentials
    public final static String CLIENT_SECRET = ""; // client secret из Google API credentials
    public final static String AUTHORIZATION_CODE = "mpro"; // поле устанавливается вручную, содержит любое уникальное значение
    public final static String CALENDAR_ID = ""; // calendar id получен     из настроек Google calendar
    public final static String APPLICATION_NAME = "Google Calendar API"; // поле содержит любое значение
